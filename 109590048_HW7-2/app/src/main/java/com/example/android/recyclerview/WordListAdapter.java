...
public class WordListAdapter extends
    ...
    class WordViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            if(mPosition == 0){
                Intent intent = new Intent(view.getContext(), Egg.class);
                view.getContext().startActivity(intent);
            }
            else if(mPosition == 1){
                Intent intent = new Intent(view.getContext(), HamAndPotato.class);
                view.getContext().startActivity(intent);
            }
            else if(mPosition == 2){
                Intent intent = new Intent(view.getContext(), TexasPulledPork.class);
                view.getContext().startActivity(intent);
            }
    ...
    public void onBindViewHolder(WordListAdapter.WordViewHolder holder,
        ...
        mCurrent = mWordList2.get(position);
